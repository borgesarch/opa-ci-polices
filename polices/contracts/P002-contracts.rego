...
errors[reason] {
	...
	reason := "[REF02] - A informação de titulo não preenchida! - https://confluence.b.net/REF02"
}

errors[reason] {
	not input.info.description
	reason := "[REF03] - A informação de descrição não preenchida! - https://confluence.b.net/REF03!"
}

errors[reason] {
	not input.info.license.name
	reason := "[REF04] - A informação de licença não preenchida! - https://confluence.b.net/REF04!"
}
